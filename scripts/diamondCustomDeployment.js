...
const diamondCutFacetAddress = "0x3C616F532cBA23F2A2690B12FCA495aAD4a16E43" // Rinkeby
const diamondInitAddress = "0xe66B2Cb2658be7Bcb0abE13346723242a7910D88" // Rinkeby
...
console.log('DiamondInit contract exists at:', diamondInit.address)
  ...
  // deploy facets
  // This script deploys all facets of the diamond, but in a real scenario most of the facets would already be deployed
  console.log('')
